...
| **T5_hit_is_in_bounds** | `Bool` | Validation that the hit is within physical detector limits. |
| **T5_hit_pos_x** | `Float` | X-coordinate of the hit in the T5 detector [mm]. |
| **T5_hit_pos_y** | `Float` | Y-coordinate of the primary hit in the T5 detector [mm]. |
| **T5_hit_time** | `Float` | Time measured by T5 for the primary hit. |
| **T5_secondary_hit_is_in_bounds** | `Bool` | Says if the hit out of the main time window is in the scintillator T5_secondary_hit_is_in_bounds|
| **T5_secondary_hit_pos_x** | `Float` | X-coordinate of the secondary hit -- hit outside of the main time window |
| **T5_secondary_hit_pos_y** | `Float` | Y-coordinate of the secondary hit -- hit outside of the main time window |
| **T5_secondary_hit_time** | `Float` | Time measured by T5 for the secondary hit -- hit outside of the main time window |
